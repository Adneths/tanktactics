...
export default function Home() {
	...
	if (boardState.players != undefined) {
		...
		if (new Date().getTime() < boardState.time) {
			...
			{
				return (<div className={styles.login}>
					You have registered, the game starts in <br/>
	...
	return (
		<div className={styles.container}>
			...
			<div className={styles.overlay} onClick={hideHistory} id="history" style={{ display: "none" }}><p>{history}</p></div>
			...
			<footer>
				...
				<Link href='/'><a onClick={showHelp}>Help</a></Link>
